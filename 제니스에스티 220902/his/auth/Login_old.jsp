...
<style type="text/css">
#HP_container {z-index:20; position:absolute;top:20px; bottom:10px;left:0;right:0; margin-left:30px; margin-right:30px; overflow:hidden; border-bottom:1px solid #d2d2d2;} 
</style>
<script>
	var root = "${ctxRoot}";
...
<h1 class="logo-area"><img src="${ctxRoot}/resources/his/img/admin/img_top_logo.gif" alt="한화손사"></a></h1>			 		
</div>
</div>
</div><!--// header -->		
</div>
...
<div class="guide-complex">

</div>

<!-- ID/PW -->
<div class="tab-cont" style="display: block;">
<div class="div_login" style="display:none;"><img class="img_login" class="Login_icon" alt="기관코드" title="기관코드" src="${image}/ic_field_hospital.png"><input type="text" name="" id="Txt_Code" class="input_txt" value="1" readonly/></div><br>
<!-- ID/PWD -->           
<div class="renewLogin">
<form id="form_login" name="form_login" action="/image/nlogin/loginByIdPwd" method="POST">
<fieldset>
<legend></legend>
...
<input type="text" id="Txt_UsrId" name="userId" style="ime-mode:disabled;" maxlength="16" placeholder="아이디를 입력하세요">
</div>



<div class="input-inbox">
<label for="pwd" class="">비밀번호</label>
...
<!--  <p class="chk">
&nbsp;
<input type="checkbox" id="idSaveFlag" name="idSaveFlag" class="custorm">
<label for="idSaveFlag"><span></span>¾ÆÀÌµðÀúÀå</label>
</p> -->                            
<div class="login-btn">
<button type="button" class="button-type-orange login_btn" id="Btn_Login">로그인</button>
</div>
</div>
<div class="login-other-wrap">

<div class="login-other-bx">
<div class="find-unit">
<ul>

<c:if test="${SSO_CHECK ne 'N'}">
<li>
	<a onclick="openWindow()" class="find-id">비밀번호 찾기</a>
</li>
</c:if>
...
<div class="infor-text-box">

<div class="infor-text-box col2">
<strong>확인하세요!</strong>
<p class="inbox-text">
정보자산에 대한 모든 접근은 기록됩니다.
</p>
<p class="inbox-text">
정보보안상 60분간 미사용시 세션이 종료됩니다.
</p>
</div>
</div>
</div>
